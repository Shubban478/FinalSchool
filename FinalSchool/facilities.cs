...
namespace FinalSchool
{
    ...
    {
        List<string> bookcase = new() { "Of Mouse And Men", "Harry Potter Collection", "The Hunger Games", "Divergent", "Basic Programing Vol. 1", "Basic Programing Vol. 2", "Git Gud In Excel" };
        ...
        public void BookList()
        {
            ...
            do
            {
                Console.WriteLine("\r\nWich one do you want to read? Type the name of the book in lowercase");

                switch (Console.ReadLine())
                {
                    case "of mouse and men":
                        Console.WriteLine("\r\nYou read Of Mouse And Men. What a great story!");
                        break;
                    case "harry potter collection":
                        Console.WriteLine("\r\nYou read Harry Potter Collection. It's very long, so you have to finish it another time.");
                        break;
                    case "the hunger games":
                        Console.WriteLine("\r\nYou read The Hunger Games. I wonder how it will end!");
                        break;
                    case "divergent":
                        Console.WriteLine("\r\nYou read Divirgent. Though you did not like it very much and did not finish it.");
                        break;
                    case "basic programing vol. 1":
                        Console.WriteLine("\r\nYou read Basic Programing Vol. 1. You learned a lot of new things! Nice!");
                        break;
                    case "basic programing vol. 2":
                        Console.WriteLine("\r\nYou read Basic Programing Vol. 2. It was too complex for you. Maybe you should read vol. 1.");
                        break;
                    case "git gud in excel":
                        Console.WriteLine("\r\nYou read Git Gud In Excel. You are now a master at Excel! Great job!");
                        break;
                    default:
